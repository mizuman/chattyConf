...
rtpg.string.START_VALUE = '# Minutes ' + minutesDate.getFullYear() + "年" + (minutesDate.getMonth()+1) + "月" + minutesDate.getDate() + "日\n";
...
rtpg.string.updateUi = function() {
  ...
  // updateHTMLMinutes();
  $("#html-minutes").html(marked(rtpg.string.field.getText()));
